...
export const inquiries = pgTable(
	"inquiries",
	{
		...
		ownerAvailabilityDecision: text("owner_availability_decision"),
		ownerVerifiedAt: timestamp("owner_verified_at", { withTimezone: true }),
		airbnbAdvisoryAtCreation: text("airbnb_advisory_at_creation"),
		airbnbLastSyncAt: timestamp("airbnb_last_sync_at", { withTimezone: true }),
		advisoryAtVerification: text("advisory_at_verification"),
		airbnbSyncAtVerification: timestamp("airbnb_sync_at_verification", { withTimezone: true }),
		quotedAmountMinor: integer("quoted_amount_minor"),
		quotedCurrency: text("quoted_currency"),
		source: text("source").notNull().default("WEBSITE"),
		emailThreadMessageId: text("email_thread_message_id"),
		telegramState: text("telegram_state"),
		telegramDraft: text("telegram_draft"),
