...
try {
for (const filename of ["0002_direct_booking_foundation.sql", "0003_cleaning_bot.sql", "0004_operations_security.sql", "0005_rls_operational_data.sql", "0006_loyalty_referral_lifecycle.sql", "0007_legal_consent_and_privacy_requests.sql"]) {
