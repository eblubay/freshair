export const hostActions = ["REPLY", "REPLY_TEXT", "AI_DRAFT", "SEND_EMAIL", "SEND_DRAFT", "EDIT", "SET_PRICE", "CLEAR_PRICE", "AVAILABLE", "NOT_AVAILABLE", "MARK_REPLIED", "GUEST_CONFIRMED", "CONFIRM_GUEST", "CREATE_BOOKING", "CONFIRM_CREATE_BOOKING", "CANCEL", "AIRBNB_STAY_CONFIRMED", "BLOCKED_DATES_ONLY", "IGNORE"] as const
